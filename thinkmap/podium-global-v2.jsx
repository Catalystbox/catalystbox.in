...
function simulate(sport,C,P,g){
  ...
  const B={
    ...
    net24:{label:netName+" (from 24)",icon:"🛡️",color:"#fbbf24",stream:streamN24,
    ...
    net18:{label:netName+" (from 20)",icon:"🛡️",color:"#fdba74",stream:streamN18,
    ...
    wash18:{label:"Washed out at 18 — weak net",icon:"⚠️",color:"#ff8775",stream:streamWash,
