...
/* ═══════════════════════════════════════════════════════════════════
   EXAM CALCULATOR · INDIA — data head
   A subject-to-exam matching engine. Rate the subjects you're strong in;
   see which exams your strengths actually fit — and what each one really
   takes to clear. Data seeded from the exam-classification dossier.
   ═══════════════════════════════════════════════════════════════════ */

export const EDITION="India";
export const EDITION_SUB="India Edition";
export const HERO_LEDE_A="Everyone is pushed toward the same three or four exams. But the smarter question is the reverse: ";
export const HERO_LEDE_B="given the subjects you're actually strong in, which exams are you best positioned to clear?";
export const HERO_LEDE_C=" Rate your strengths, and this ranks every major Indian exam by how well it fits you — then tells you what each one truly demands, because two exams needing the same subjects can be completely different fights.";

/* ── the subjects a person can be strong in ───────────────────────── */
export const GROUPS=[
...
export const SKILLS=[
  {key:"math",  g:"school",  label:"Advanced Mathematics", hint:"Calculus, algebra, proofs (JEE/GATE-level)"},
  ...
  {key:"soc",   g:"school",  label:"Social Science", hint:"History, Polity, Geography"},
  {key:"reason",g:"aptitude",label:"Logical & Analytical Reasoning"},
  {key:"quant", g:"aptitude",label:"Quantitative Aptitude", hint:"Fast arithmetic, %, ratio, DI-speed"},
  {key:"di",    g:"aptitude",label:"Data Interpretation"},
  {key:"gk",    g:"aptitude",label:"General Knowledge & Current Affairs"},
  {key:"essay", g:"aptitude",label:"Essay & Descriptive Writing"},
  {key:"decide",g:"aptitude",label:"Decision Making"},
  {key:"legal", g:"special", label:"Legal Aptitude"},
  {key:"design",g:"special", label:"Drawing, Design & Visualisation"},
  {key:"code",  g:"special", label:"Programming & Computers"},
  {key:"econ",  g:"special", label:"Economics & Finance"},
  {key:"acct",  g:"special", label:"Accounting & Commerce"},
  {key:"tech",  g:"special", label:"Engineering / Technical Core", hint:"Depth in your own engineering discipline"},
  {key:"clin",  g:"special", label:"Clinical / Biomedical Knowledge"},
];

/* ── the four psychometric natures — the spine of the tool ─────────── */
export const NATURE={
  elimination:{label:"Elimination Bottleneck",color:"#e0563f",tint:"rgba(224,86,63,.12)",
    ...
    detail:"Norm-referenced and tuned to the extreme top. You are not proving competence — you are out-ranking millions for very few seats. Zero-sum, and the reason a giant coaching industry exists. A high subject-fit gets you into the fight, not through it."},
  competency:{label:"Competency Gate",color:"#0B5C45",tint:"rgba(11,92,69,.12)",
    ...
    detail:"Criterion-referenced pass/fail. There is a set standard; everyone who meets it can pass, so it is non-zero-sum and rewards steady mastery over beating peers. Here a strong subject-fit genuinely predicts clearing it."},
  aptitude:{label:"Aptitude Gauge",color:"#4a7fb5",tint:"rgba(74,127,181,.12)",
    ...
    detail:"Prognostic and broad-range — it estimates general reasoning across a wide band rather than one deep syllabus. Usually retakeable, with scaled scores compared holistically. Fit maps fairly well to outcome."},
  talent:{label:"Talent Search",color:"#8a6dc0",tint:"rgba(138,109,192,.12)",
    ...
    detail:"Diagnostic and top-fraction — built around unorthodox, very hard problems to discover exceptional potential rather than test a fair curriculum. Subject-fit is necessary but the real filter is originality under pressure."},
};

export const FIELDS=[
  {k:"engineering",label:"Engineering"},
  {k:"medical",label:"Medical"},
  {k:"civil-services",label:"Civil Services"},
  {k:"ssc-railways",label:"SSC & Railways"},
  {k:"banking-finance",label:"Banking & Finance"},
  {k:"law",label:"Law"},
  {k:"management",label:"Management"},
  {k:"design",label:"Design"},
  {k:"research-teaching",label:"Research & Teaching"},
  {k:"defense",label:"Defence"},
  {k:"licensure",label:"Professional Licensure"},
  {k:"admission",label:"University Admission"},
];
export const LEVELS=[
  {k:"ug",label:"After Class 12"},
  {k:"pg",label:"After Graduation"},
  {k:"job",label:"Government Jobs"},
  {k:"licensure",label:"Professional Licensure"},
  {k:"fellowship",label:"Olympiad / Fellowship"},
];

export const PRESETS={
  "Science · PCM":{math:8,phys:8,chem:7,bio:2,eng:6,soc:3,reason:7,quant:7,di:5,gk:4,essay:4,decide:4,legal:3,design:3,code:5,econ:3,acct:3,tech:6,clin:2},
  "Science · PCB":{math:4,phys:6,chem:7,bio:9,eng:6,soc:3,reason:6,quant:5,di:4,gk:4,essay:4,decide:3,legal:2,design:3,code:3,econ:2,acct:2,tech:3,clin:5},
  "Commerce":{math:5,phys:2,chem:2,bio:2,eng:6,soc:4,reason:6,quant:7,di:6,gk:5,essay:5,decide:5,legal:4,design:2,code:3,econ:8,acct:8,tech:2,clin:1},
  "Humanities":{math:3,phys:2,chem:2,bio:2,eng:8,soc:8,reason:6,quant:4,di:4,gk:8,essay:8,decide:5,legal:5,design:3,code:2,econ:5,acct:3,tech:1,clin:1},
  "Coding / IT":{math:7,phys:5,chem:3,bio:2,eng:6,soc:3,reason:8,quant:7,di:6,gk:4,essay:4,decide:5,legal:2,design:3,code:9,econ:3,acct:3,tech:7,clin:1},
...
/* ── the exams. req weights are relative (engine normalises).
      core = must-have gate subjects. mode:"any" = pick-your-subject.  */
export const EXAMS=[
  /* ENGINEERING */
  {n:"JEE Main",full:"Joint Entrance Examination (Main)",field:"engineering",level:"ug",nat:"elimination",eff:"extreme",
   req:{math:.33,phys:.33,chem:.34},core:["math","phys","chem"],to:"NITs, IIITs & the gateway to JEE Advanced."},
  {n:"JEE Advanced",full:"Joint Entrance Examination (Advanced)",field:"engineering",level:"ug",nat:"elimination",eff:"extreme",
   req:{math:.34,phys:.33,chem:.33},core:["math","phys","chem"],to:"The IITs — India's top engineering institutes.",
   note:"Among the hardest undergraduate entrance exams in the world; extreme right-tail selection."},
  {n:"BITSAT",full:"BITS Admission Test",field:"engineering",level:"ug",nat:"elimination",eff:"high",
   req:{math:.28,phys:.26,chem:.26,eng:.1,reason:.1},core:["math","phys","chem"],to:"BITS Pilani, Goa & Hyderabad."},
  {n:"MHT-CET",full:"Maharashtra Common Entrance Test",field:"engineering",level:"ug",nat:"elimination",eff:"high",
   req:{math:.34,phys:.32,chem:.34},core:["phys","chem"],to:"Maharashtra engineering & pharmacy colleges."},
  {n:"VITEEE",full:"VIT Engineering Entrance Examination",field:"engineering",level:"ug",nat:"aptitude",eff:"medium",
   req:{math:.3,phys:.28,chem:.28,eng:.07,reason:.07},core:["phys","chem"],to:"VIT campuses."},
  {n:"NATA",full:"National Aptitude Test in Architecture",field:"design",level:"ug",nat:"aptitude",eff:"high",
   req:{design:.5,math:.25,phys:.25},core:["design"],to:"Five-year Bachelor of Architecture programmes."},
  {n:"IMU CET",full:"Indian Maritime University Common Entrance Test",field:"engineering",level:"ug",nat:"elimination",eff:"medium",
   req:{phys:.24,math:.24,chem:.2,eng:.16,gk:.16},core:["phys","math"],to:"Marine engineering & nautical science."},
  {n:"GATE",full:"Graduate Aptitude Test in Engineering",field:"engineering",level:"pg",nat:"aptitude",eff:"high",
   req:{tech:.55,math:.25,eng:.08,reason:.12},core:["tech"],to:"M.Tech at IITs/NITs & direct PSU recruitment."},
  {n:"IIT JAM",full:"Joint Admission Test for Masters",field:"research-teaching",level:"pg",nat:"elimination",eff:"high",mode:"any",
   req:{phys:.34,chem:.33,math:.33},core:[],to:"M.Sc & integrated PhD at IITs and IISc.",
   note:"Pick-your-subject: your single strongest science drives the fit."},
  {n:"JEST",full:"Joint Entrance Screening Test",field:"research-teaching",level:"pg",nat:"talent",eff:"high",mode:"any",
   req:{phys:.6,code:.25,math:.15},core:[],to:"PhD at premier physics & theoretical-CS institutes."},

  /* MEDICAL */
  {n:"NEET-UG",full:"National Eligibility cum Entrance Test (UG)",field:"medical",level:"ug",nat:"elimination",eff:"extreme",
   req:{bio:.5,phys:.25,chem:.25},core:["bio","chem"],to:"MBBS, BDS, AYUSH & veterinary seats nationwide.",
   note:"Single-window for nearly all medical admissions; Biology is the decisive half."},
  {n:"NEET-PG",full:"National Eligibility cum Entrance Test (PG)",field:"medical",level:"pg",nat:"elimination",eff:"extreme",
   req:{clin:1.0},core:["clin"],to:"MD, MS & PG-diploma medical seats.",
   note:"Requires a completed MBBS; tests the full clinical syllabus."},
  {n:"INI-CET",full:"Institute of National Importance Combined Entrance Test",field:"medical",level:"pg",nat:"elimination",eff:"extreme",
   req:{clin:1.0},core:["clin"],to:"Residency at AIIMS, JIPMER, PGIMER & NIMHANS."},

  /* DESIGN */
  {n:"NIFT Entrance",full:"NIFT Entrance Examination",field:"design",level:"ug",nat:"talent",eff:"high",
   req:{design:.6,gk:.15,reason:.15,eng:.1},core:["design"],to:"Fashion design, technology & management at NIFT."},
  {n:"UCEED",full:"Undergraduate Common Entrance Exam for Design",field:"design",level:"ug",nat:"talent",eff:"high",
   req:{design:.45,reason:.3,eng:.1,gk:.15},core:["design"],to:"Design programmes at IIT Bombay & others."},
  {n:"NID DAT",full:"NID Design Aptitude Test",field:"design",level:"ug",nat:"talent",eff:"high",
   req:{design:.6,reason:.2,gk:.2},core:["design"],to:"India's National Institutes of Design."},

  /* MANAGEMENT */
  {n:"CAT",full:"Common Admission Test",field:"management",level:"pg",nat:"elimination",eff:"extreme",
   req:{quant:.33,eng:.33,di:.34},core:["quant","eng","di"],to:"The IIMs & premier business schools.",
   note:"DILR (data interpretation + logic) is a full third and decides most results."},
  {n:"XAT",full:"Xavier Aptitude Test",field:"management",level:"pg",nat:"elimination",eff:"high",
   req:{decide:.25,eng:.25,quant:.22,di:.16,gk:.12},core:[],to:"XLRI Jamshedpur & associate schools.",
   note:"Unique Decision-Making section rewards structured judgement over speed."},
  {n:"IPMAT",full:"Integrated Program in Management Aptitude Test",field:"management",level:"ug",nat:"elimination",eff:"high",
   req:{math:.5,quant:.25,eng:.25},core:["math"],to:"Five-year integrated management at IIM Indore/Rohtak."},
  {n:"NMAT",full:"NMIMS Management Aptitude Test",field:"management",level:"pg",nat:"aptitude",eff:"medium",
   req:{eng:.33,quant:.34,reason:.33},core:[],to:"NMIMS & several private B-schools.",
   note:"Adaptive and retakeable up to three times a cycle — a gentler nature than CAT."},
  {n:"SNAP",full:"Symbiosis National Aptitude Test",field:"management",level:"pg",nat:"aptitude",eff:"medium",
   req:{eng:.34,quant:.33,reason:.33},core:[],to:"Symbiosis institutes."},
  {n:"IIFT",full:"IIFT Admission Test",field:"management",level:"pg",nat:"elimination",eff:"high",
   req:{quant:.3,eng:.25,di:.25,gk:.2},core:[],to:"MBA in International Business at IIFT."},
  {n:"TISSNET",full:"TISS National Entrance Test",field:"management",level:"pg",nat:"elimination",eff:"high",
   req:{gk:.4,quant:.3,eng:.3},core:[],to:"Social sciences, HR & public policy at TISS.",
   note:"Unusually GK-heavy for a management test."},

  /* LAW */
  {n:"CLAT",full:"Common Law Admission Test",field:"law",level:"ug",nat:"aptitude",eff:"high",
   req:{legal:.25,gk:.2,eng:.2,reason:.2,quant:.15},core:[],to:"The National Law Universities (NLUs)."},
  {n:"AILET",full:"All India Law Entrance Test",field:"law",level:"ug",nat:"elimination",eff:"high",
   req:{eng:.3,reason:.35,gk:.35},core:[],to:"NLU Delhi — a single, very selective intake."},
  {n:"SLAT",full:"Symbiosis Law Admission Test",field:"law",level:"ug",nat:"aptitude",eff:"medium",
   req:{legal:.25,reason:.25,eng:.25,gk:.25},core:[],to:"Symbiosis Law Schools."},
  {n:"AIBE",full:"All India Bar Examination",field:"law",level:"licensure",nat:"competency",eff:"medium",
   req:{legal:1.0},core:["legal"],to:"The licence to practise law in India.",
   note:"Open-book, pass/fail — designed to certify basic practice, not to rank."},
  {n:"PCS-J",full:"Provincial Civil Service (Judicial)",field:"law",level:"job",nat:"elimination",eff:"extreme",
   req:{legal:.8,essay:.1,eng:.1},core:["legal"],to:"Entry-level judge & magistrate posts."},

  /* CIVIL SERVICES & DEFENCE */
  {n:"UPSC CSE",full:"Civil Services Examination",field:"civil-services",level:"job",nat:"elimination",eff:"extreme",
   req:{gk:.24,soc:.24,essay:.2,eng:.1,reason:.1,quant:.12},core:[],to:"The IAS, IPS, IFS & allied services.",
   note:"A multi-stage marathon over a year; among the most competitive selections anywhere."},
  {n:"UPSC ESE",full:"Engineering Services Examination",field:"civil-services",level:"job",nat:"elimination",eff:"extreme",
   req:{tech:.6,gk:.2,reason:.2},core:["tech"],to:"Officer engineering cadres in central government."},
  {n:"UPSC CDS",full:"Combined Defence Services Examination",field:"defense",level:"job",nat:"aptitude",eff:"high",
   req:{eng:.3,gk:.35,math:.35},core:[],to:"Officer entry to the Army, Navy & Air Force academies."},
  {n:"UPSC CAPF",full:"Central Armed Police Forces (Assistant Commandants)",field:"defense",level:"job",nat:"elimination",eff:"high",
   req:{gk:.3,reason:.2,quant:.2,essay:.15,eng:.15},core:[],to:"Officer posts in the central paramilitary forces."},
  {n:"AFCAT",full:"Air Force Common Admission Test",field:"defense",level:"job",nat:"aptitude",eff:"medium",
   req:{eng:.25,quant:.25,reason:.25,gk:.25},core:[],to:"Flying, technical & ground-duty officer branches, IAF."},
  {n:"State PSC",full:"State Public Service Commission Exams",field:"civil-services",level:"job",nat:"elimination",eff:"extreme",
   req:{gk:.3,soc:.3,essay:.15,eng:.1,reason:.15},core:[],to:"State administrative officers (SDM, DSP, Tehsildar)."},

  /* SSC & RAILWAYS */
  {n:"SSC CGL",full:"SSC Combined Graduate Level",field:"ssc-railways",level:"job",nat:"elimination",eff:"high",
   req:{quant:.3,reason:.25,eng:.2,gk:.25},core:[],to:"Group B & C posts across central ministries."},
  {n:"SSC CHSL",full:"SSC Combined Higher Secondary Level",field:"ssc-railways",level:"job",nat:"aptitude",eff:"medium",
   req:{eng:.25,reason:.25,quant:.25,gk:.25},core:[],to:"Clerical & data-entry roles in central offices."},
  {n:"SSC JE",full:"SSC Junior Engineer",field:"ssc-railways",level:"job",nat:"aptitude",eff:"medium",
   req:{tech:.55,reason:.2,gk:.25},core:["tech"],to:"Junior engineer posts in public works."},
  {n:"RRB NTPC",full:"Railway Recruitment Board — Non-Technical Popular Categories",field:"ssc-railways",level:"job",nat:"elimination",eff:"medium",
   req:{gk:.35,quant:.3,reason:.35},core:[],to:"Station masters, clerks & traffic roles in the Railways."},
  {n:"RRB JE",full:"Railway Recruitment Board — Junior Engineer",field:"ssc-railways",level:"job",nat:"aptitude",eff:"medium",
   req:{tech:.5,quant:.2,reason:.15,gk:.15},core:["tech"],to:"Technical supervision across Indian Railways."},

  /* BANKING & FINANCE */
  {n:"SBI PO",full:"State Bank of India Probationary Officer",field:"banking-finance",level:"job",nat:"aptitude",eff:"high",
   req:{eng:.24,quant:.28,reason:.24,di:.14,gk:.1},core:[],to:"Officer-trainee leadership track at SBI."},
  {n:"IBPS PO",full:"IBPS Probationary Officer",field:"banking-finance",level:"job",nat:"aptitude",eff:"high",
   req:{eng:.24,quant:.28,reason:.24,di:.14,gk:.1},core:[],to:"Officer posts across public-sector banks."},
  {n:"RBI Grade B",full:"Reserve Bank of India Grade B Officer",field:"banking-finance",level:"job",nat:"elimination",eff:"extreme",
   req:{econ:.25,gk:.2,quant:.18,eng:.17,reason:.2},core:[],to:"Officer cadre at India's central bank.",
   note:"Economics & Social Issues + Finance make this far more than an aptitude test."},
  {n:"NABARD Grade A",full:"NABARD Development Assistant / Grade A",field:"banking-finance",level:"job",nat:"aptitude",eff:"high",
   req:{econ:.25,reason:.2,eng:.15,quant:.2,gk:.2},core:[],to:"Rural-development & agricultural-finance banking."},
  {n:"Bank Clerk (IBPS/SBI)",full:"IBPS & SBI Clerk Examinations",field:"banking-finance",level:"job",nat:"aptitude",eff:"medium",
   req:{eng:.28,quant:.28,reason:.24,gk:.2},core:[],to:"Clerical cadre across nationalised banks."},
  {n:"LIC AAO",full:"LIC Assistant Administrative Officer",field:"banking-finance",level:"job",nat:"aptitude",eff:"high",
   req:{reason:.25,quant:.25,eng:.2,gk:.15,econ:.15},core:[],to:"Administrative & risk roles in public insurance."},

  /* PROFESSIONAL LICENSURE */
  {n:"CA",full:"Chartered Accountant (ICAI)",field:"licensure",level:"licensure",nat:"competency",eff:"extreme",
   req:{acct:.4,econ:.2,legal:.2,quant:.2},core:["acct"],to:"India's chartered accountancy licence.",
   note:"Criterion-referenced across three stages; famously low pass rates but not rank-based — you compete against the standard."},
  {n:"CS",full:"Company Secretary (ICSI)",field:"licensure",level:"licensure",nat:"competency",eff:"high",
   req:{legal:.4,acct:.2,econ:.2,gk:.2},core:["legal"],to:"Corporate governance & secretarial-audit practice."},
  {n:"CMA",full:"Cost & Management Accountant (ICMAI)",field:"licensure",level:"licensure",nat:"competency",eff:"high",
   req:{acct:.4,econ:.3,quant:.3},core:["acct"],to:"Cost & management accountancy practice."},
  {n:"ACET",full:"Actuarial Common Entrance Test",field:"licensure",level:"licensure",nat:"aptitude",eff:"high",
   req:{math:.4,quant:.3,di:.15,eng:.15},core:["math"],to:"Student membership of the Institute of Actuaries.",
   note:"Heavy on probability & statistics — a mathematician's gateway."},
  {n:"ACCA",full:"Chartered Certified Accountant",field:"licensure",level:"licensure",nat:"competency",eff:"high",
   req:{acct:.4,legal:.2,econ:.2,quant:.2},core:["acct"],to:"A globally portable accountancy qualification."},

  /* RESEARCH, TEACHING & OLYMPIADS */
  {n:"UGC NET",full:"UGC National Eligibility Test",field:"research-teaching",level:"pg",nat:"aptitude",eff:"high",mode:"any",
   req:{soc:.5,reason:.2,eng:.15,gk:.15},core:[],to:"Assistant-professor eligibility & Junior Research Fellowships.",
   note:"Paper II is your own postgraduate subject — your domain strength is what counts."},
  {n:"CSIR NET",full:"CSIR National Eligibility Test",field:"research-teaching",level:"pg",nat:"elimination",eff:"high",mode:"any",
   req:{phys:.3,chem:.3,bio:.3,math:.3,reason:.1},core:[],to:"Science lectureship & research fellowships.",
   note:"Pick-your-science: your single strongest discipline drives the fit."},
  {n:"IOQM",full:"Indian Olympiad Qualifier in Mathematics",field:"research-teaching",level:"fellowship",nat:"talent",eff:"high",
   req:{math:1.0},core:["math"],to:"The first step toward the International Maths Olympiad.",
   note:"Proof-based, no calculus — rewards creative problem-solving over syllabus coverage."},
  {n:"INMO",full:"Indian National Mathematical Olympiad",field:"research-teaching",level:"fellowship",nat:"talent",eff:"extreme",
   req:{math:1.0},core:["math"],to:"The national maths-olympiad squad & IMO camp."},
  {n:"KVPY / INSPIRE",full:"Science Talent Fellowship (KVPY lineage / INSPIRE)",field:"research-teaching",level:"fellowship",nat:"talent",eff:"high",mode:"any",
   req:{phys:.3,chem:.3,bio:.3,math:.3},core:[],to:"Fellowships for a career in basic-science research."},
  {n:"NTSE",full:"National Talent Search Examination",field:"research-teaching",level:"fellowship",nat:"talent",eff:"medium",
   req:{reason:.35,soc:.2,phys:.15,chem:.15,bio:.15},core:[],to:"A national scholarship for high-potential school students."},
  {n:"TIFR GS",full:"TIFR Graduate School Admissions",field:"research-teaching",level:"pg",nat:"talent",eff:"high",mode:"any",
   req:{phys:.3,math:.3,chem:.2,bio:.2,code:.2},core:[],to:"Integrated PhD at the Tata Institute of Fundamental Research."},
  {n:"NBHM",full:"National Board for Higher Mathematics Scholarship",field:"research-teaching",level:"fellowship",nat:"talent",eff:"high",
   req:{math:1.0},core:["math"],to:"Postgraduate mathematics scholarships & fellowships."},

  /* PSU SCIENTIST & IT */
  {n:"ISRO Scientist",full:"ISRO Scientist / Engineer Exam",field:"engineering",level:"job",nat:"talent",eff:"high",
   req:{tech:.7,reason:.3},core:["tech"],to:"Research-scientist roles at India's space agency."},
  {n:"DRDO Scientist",full:"DRDO Scientist Exam",field:"engineering",level:"job",nat:"talent",eff:"high",
   req:{tech:.7,reason:.3},core:["tech"],to:"Defence-technology research laboratories."},
  {n:"BARC OCES",full:"BARC Orientation Course for Engineering Graduates",field:"engineering",level:"job",nat:"talent",eff:"high",
   req:{tech:.65,phys:.2,reason:.15},core:["tech"],to:"Scientific-officer entry to India's nuclear programme."},
  {n:"TCS NQT",full:"TCS National Qualifier Test",field:"engineering",level:"job",nat:"aptitude",eff:"low",
   req:{code:.4,quant:.25,reason:.2,eng:.15},core:[],to:"Entry-level software roles at TCS & beyond."},
  {n:"Infosys NQT",full:"Infosys National Qualifier Test",field:"engineering",level:"job",nat:"aptitude",eff:"low",
   req:{code:.4,quant:.25,reason:.2,eng:.15},core:[],to:"Software-engineering roles at Infosys."},

  /* UG GENERAL */
  {n:"CUET-UG",full:"Common University Entrance Test (UG)",field:"admission",level:"ug",nat:"aptitude",eff:"medium",mode:"any",
   req:{eng:.3,gk:.2,reason:.2,soc:.15,math:.15},core:[],to:"Central & participating universities across India.",
   note:"Domain sections vary by chosen subject; the language + general test are common to all."},
  {n:"CUET-PG",full:"Common University Entrance Test (Postgraduate)",field:"admission",level:"pg",nat:"aptitude",eff:"medium",mode:"any",
   req:{eng:.25,gk:.2,reason:.2,soc:.15,econ:.1,math:.1},core:[],to:"Postgraduate programmes at central & participating universities.",
   note:"You sit the paper for your intended PG subject, so your strongest area anchors the fit."},
];

export const LANG_REF=[]; /* India edition: no separate language block *//* ═══════════════════════════════════════════════════════════════════
...
.tm-wrap{--ink:#0a0d14;--ink-3:#11161f;--teal:#0B5C45;--teal-line:#34c79a;--teal-tint:#e7efe9;--amber:#E8922A;--clay:#c2691f;--amber-tint:#f8ead6;--blue:#4a7fb5;--blue-tint:#e8eff8;--parch:#f5f1e8;--paper:#fbfaf6;--line:#e4dccb;--tx:#0a0d14;--tx-soft:#3a4250;--tx-mut:#6b7280;}
*{box-sizing:border-box;margin:0;padding:0}
.wrap{background:var(--parch);color:var(--tx);font-family:'Inter',system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,sans-serif;-webkit-font-smoothing:antialiased;line-height:1.5;padding:22px 16px 40px;max-width:1200px;margin:0 auto}
.wrap h1{font-family:'Inter',sans-serif;letter-spacing:-0.02em}
.top{margin-bottom:16px}
.brand{display:inline-flex;align-items:center;gap:7px;font-family:'Inter',sans-serif;font-weight:700;font-size:13px;letter-spacing:.04em;color:var(--teal);text-transform:uppercase;margin-bottom:12px}
...
.sub{font-family:'Inter',sans-serif;font-weight:700;font-size:clamp(14px,2.6vw,19px);color:var(--teal);margin-bottom:10px}
